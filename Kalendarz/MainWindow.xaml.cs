...
namespace WAT
{
    ...
    {
        private static string login = Encryptor.Decrypt(Settings.Default.Login);
        private static string pass = Encryptor.Decrypt(Settings.Default.Pass);
        private static string groupNo = Encryptor.Decrypt(Settings.Default.Group);
        ...
        {
            download(Encryptor.Decrypt(Settings.Default.Group),
                Settings.Default.Season, DateTime.Now,
        ...
        private void ShowSettings_Click(object sender, RoutedEventArgs e)
        {
            ...
            frm.ShowDialog();
            login = Encryptor.Decrypt(Settings.Default.Login);
            pass = Encryptor.Decrypt(Settings.Default.Pass);
            groupNo = Encryptor.Decrypt(Settings.Default.Group);
        }
