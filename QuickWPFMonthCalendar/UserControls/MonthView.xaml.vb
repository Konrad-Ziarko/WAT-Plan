...
Partial Public Class MonthView
    ...
    Public _monthAppointments As List(Of Appointment.Appointment)
    ...
    Public Property MonthAppointments() As List(Of Appointment.Appointment)
        Get
            Return _monthAppointments
        End Get
        Set(ByVal value As List(Of Appointment.Appointment))
    ...
    Private Sub BuildCalendarUI()
        Dim iDaysInMonth As Integer = System.DateTime.DaysInMonth(_DisplayStartDate.Year, _DisplayStartDate.Month)
        Dim iOffsetDays As Integer = CInt(_DisplayStartDate.DayOfWeek)
        ...
        MonthYearLabel.Content = Microsoft.VisualBasic.MonthName(_DisplayMonth).ToUpper() & " " & _DisplayYear
        ...
        For i As Integer = 1 To iDaysInMonth
            ...
            ElseIf _monthAppointments IsNot Nothing Then
                ...
                Dim aptInDay As List(Of Appointment.Appointment) =
                    _monthAppointments.FindAll(New System.Predicate(Of Appointment.Appointment)(
                                               Function(apt As Appointment.Appointment) CDate(apt.StartTime).Day = iday))
                For Each a As Appointment.Appointment In aptInDay
                    Dim apt As New DayBoxAppointmentControl()
                    apt.BorderElement.BorderBrush = New SolidColorBrush(Color.FromArgb(a.BBA, a.BBR, a.BBG, a.BBB))
                    apt.BorderElement.Background = New SolidColorBrush(Color.FromArgb(a.BGA, a.BGR, a.BGG, a.BGB))
...
#Region " UI Event Handlers "
    ...
    Private Sub DayBox_DoubleClick(ByVal sender As Object, ByVal e As MouseButtonEventArgs)
        ...
        If e.Source.GetType Is GetType(DayBoxControl) AndAlso
